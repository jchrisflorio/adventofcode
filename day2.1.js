var arrSpreadsheet =    "121	59	141	21	120	67	58	49	22	46	56	112	53	111	104	130\n" + 
...
var rows = arrSpreadsheet.split("\n");
var results = 0;
for (var i = 0;i <rows.length; i++ ){
    //console.log("rows=" + rows[i].toString());
    ...
    var div;
        ...
        for(j = 0; j < cols.length; j++) {
            for(k = 0; k < cols.length; k++) {
                ...
                else if (Number.isInteger(cols[j]/cols[k])){
                    results +=   cols[j]/cols[k];
